...
4 - Изменить контакт\n5 - Удалить контакт\n6 - Просмотреть все контакты\n0 - Выйти из приложения\n')
        ...
        if user_choice == '1':
            ...
            import_data(file_to_add, phone_book)
        elif user_choice == '2':
...
def import_data(file_to_add, phone_book):
    try:
        with open(file_to_add, 'r', encoding='utf-8') as new_contacts, open(phone_book, 'a', encoding='utf-8') as file:
